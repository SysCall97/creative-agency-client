        ...
        <div>
            ...
            <div style={{display:"block"}}>
                <Link to="/customer/order"  style={{textDecoration:"none"}}>
                    <div className="d-flex justify-content-start align-items-center mb-4 mt-4">
                        <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-cart" fill={active === 'order' ? "#009444" : "#000"} xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to="/customer/serviceList"  style={{textDecoration:"none"}}>
                    <div className="d-flex justify-content-start align-items-center mb-4 mt-4">
                        <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-hdd" fill={active === 'serviceList' ? "#009444" : "#000"} xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path fill-rule="evenodd" d="M4.094 4a.5.5 0 0 0-.44.26l-2.47 4.532A1.5 1.5 0 0 0 1 9.51v.99H0v-.99c0-.418.105-.83.305-1.197l2.472-4.531A1.5 1.5 0 0 1 4.094 3h7.812a1.5 1.5 0 0 1 1.317.782l2.472 4.53c.2.368.305.78.305 1.198v.99h-1v-.99a1.5 1.5 0 0 0-.183-.718L12.345 4.26a.5.5 0 0 0-.439-.26H4.094z" /></svg>
                ...
                <Link to="/customer/review"  style={{textDecoration:"none"}}>
                    <div className="d-flex justify-content-start align-items-center mb-4 mt-4">
                        <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-chat-left-dots" fill={active === 'review' ? "#009444" : "#000"} xmlns="http://www.w3.org/2000/svg">
            ...
            <div style={{display:"block"}}  style={{textDecoration:"none"}}>
                ...
                <Link to="/admin/addService"  style={{textDecoration:"none"}}>
                    <div className="d-flex justify-content-start align-items-center mb-4 mt-4">
                        <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-plus" fill={active === 'addService' ? "#009444" : "#000"} xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to="/admin/makeAdmin"  style={{textDecoration:"none"}}>
                    <div className="d-flex justify-content-start align-items-center mb-4 mt-4">
                        <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-person-plus" fill={active === 'makeAdmin' ? "#009444" : "#000"} xmlns="http://www.w3.org/2000/svg">
